...
describe("calculateLetterGrade", () => {
  test("if a student have mark greater than 0 so we can evalute him", () => {

    expect(questionGrades).toBeGreaterThan(0);
  });
  test("to be value between 0 and 5 to be in the evaluation test", () => {
    const testArray = [1, 2, 3, 4, 5]

    expect(testArray).toBeContain(2);
  });
  test("here we evaluate his degree ", () => {
    const testArray = [1, 2, 3, 4, 5]
