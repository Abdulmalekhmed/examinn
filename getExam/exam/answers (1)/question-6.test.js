...
describe("calculateLetterGrade", () => {
  test("Test incomplete", () => {
    expect(calculateLetterGrade([])).toBe("Incomplete");
    expect(calculateLetterGrade([-1, 6])).toBe("Incomplete");
  });

  test("Correct grades", () => {
    expect(calculateLetterGrade([0, 2])).toBe("F");
    expect(calculateLetterGrade([0, 3])).toBe("D");
    expect(calculateLetterGrade([1, 3])).toBe("D");
    expect(calculateLetterGrade([2, 3])).toBe("C");
